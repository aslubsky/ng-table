...
!function (a, b) {
    ...
    return b.value("ngTableDefaults", {
        ...
        var e = function (a) {
            ...
            this.data = [], this.parameters = function (b, c) {
                ...
                if (d = d && 6 > d ? 6 : d, i = [], h = Math.ceil(b / c), h > 1) {
                    i.push({type: "prev", number: Math.max(1, a - 1), active: a > 1}), i.push({
                        ...
                        active: a > 1,
                        current: 1 === a
                    }), f = Math.round((k.paginationMaxBlocks - k.paginationMinBlocks) / 2), g = Math.max(2, a - f), e = Math.min(h - 1, a + 2 * f - (a - g)), g = Math.max(2, g - (2 * f - (e - g)));
            ...
            return a.extend(k, d.settings), this.settings(g), this.parameters(f, !0), this.checkboxes = {
                checkedVisible: {},
                checkedAll: !1,
                checkedPage: {},
                checkedAny: !1,
        ...
        b.$watch("params.$params", function (c, d) {
            if (c !== d) {
                if (a.forEach(c.filter, function (b, d) {
                        (!b || a.isDefined(b[0]) && 0 == b[0].length) && delete c.filter[d]
                    }), b.params.settings().$scope = b, a.equals(c.filter, d.filter))b.params.reload(); else {
                    var e = k ? a.noop : j;
                    l(function () {
                        e(), b.params.reload()
            ...
            if (!h.hasClass("ng-table")) {
                b.templates = {
                    ...
                    mobileFilters: g.templateMobileFilters ? g.templateMobileFilters : "ng-table/mobile-filters.html"
                }, h.addClass("ng-table");
                var c = null;
                0 === h.find("> thead").length && (c = a.element(document.createElement("thead")).attr("ng-include", "templates.header"), h.prepend(c));
                var d = a.element(document.createElement("div")).attr({"ng-include": "templates.mobileFilters"}), e = a.element(document.createElement("div")).attr({
                    "class": "ng-table-pagination",
                    "ng-table-pagination": "params",
                    "template-url": "templates.pagination"
                });
                h.before(d), h.after(e), c && f(c)(b), f(d)(b), f(e)(b)
            }
            ...
            a.forEach(c, function (c) {
                ...
                return d = c.filterData(b, {$column: c}), d ? a.isObject(d) && a.isObject(d.promise) ? (delete c.filterData, d.promise.then(function (b) {
                    a.isArray(b) || a.isFunction(b) || a.isObject(b) ? a.isArray(b) : b = [], c.data = b
    ...
    }]), b.directive("ngTable", ["$q", "$parse", "NgTableParams", function (b, c, d) {
        return {
            restrict: "A", priority: 1001, scope: !0, controller: "ngTableController", compile: function (b) {
                var e = (new d).isMobileDevice(), f = [], g = 0, h = null;
                return a.forEach(a.element(b.find("tr")), function (b) {
                    b = a.element(b), b.hasClass("ng-table-group") || h || (h = b)
                }), h ? (a.forEach(h.find("td"), function (b) {
                    var d = a.element(b);
                    if (!d.attr("ignore-cell") || "true" !== d.attr("ignore-cell")) {
                        var h = "" == d.attr("hide-on-mobile") ? !0 : !1;
                        h && e && (d.hide(), d.attr("ng-show", "false"));
                        var i = function (a) {
                            return d.attr("x-data-" + a) || d.attr("data-" + a) || d.attr(a)
                        }, j = function (b) {
                            var d = i(b);
                            return d ? function (b, e) {
                                return c(d)(b, a.extend(e || {}, {$columns: f}))
                            } : void 0
                        }, k = i("title-alt") || i("title");
                        k && d.attr("data-title-text", "{{" + k + "}}"), f.push({
                            ...
                            show: d.attr("ng-show") ? function (a) {
                                return c(d.attr("ng-show"))(a)
                            } : void 0
                        })
                    }
                }), function (a, b, c, d) {
